Scoop bucket for hymkor's and favorite softwares
================================================
...
* [csvi](https://github.com/hymkor/csvi) 1.17.0 - Terminal CSV Editor
...
* [example-into-readme](https://github.com/hymkor/example-into-readme) 0.8.1 - Insert example-files into `README.md` at the code block in the current directory.
...
* [make-scoop-manifest](https://github.com/hymkor/make-scoop-manifest) 0.11.0 - Make the manifest file of the scoop-installer
* [minipage](https://github.com/hymkor/minipage) 0.10.0 - Minimal Static Page Generator
...
* [sqlbless](https://github.com/hymkor/sqlbless) 0.27.0 - The Command-line Database Client
...
nyaosorg
* [box](https://github.com/nyaosorg/go-box) 3.0.0 - go-box - interactive item selector for the terminal
